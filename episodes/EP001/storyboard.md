# Storyboard — EP001 The Woman Behind the Flat-Bottom Paper Bag

| Scene | Time | Narration beat | Visual/action | On-screen text | Existing asset? | Transition |
|---:|---|---|---|---|---|---|
| 1 | 0:00–0:08 | A grocery bag stands upright | Modern flat-bottom bag drops onto a counter and pops open; mascot peeks inside | “Why does it stand?” | No | Quick drop and squash |
| 2 | 0:08–0:15 | An ordinary shape was once a problem | Rewind arrow transforms the bag into a floppy envelope-style bag; Knight and a machine silhouette appear | “An old factory problem” | No | Hand-drawn rewind |
| 3 | 0:15–0:32 | Knight grows up around machinery | Map pin moves from Maine to Springfield; simplified Knight gains a tool apron | “Margaret Knight” / “1838–1914” | No | Map-line wipe |
| 4 | 0:32–0:50 | Hand production at Columbia Paper Bag Company | Three workers repeat fold-and-paste motions; stacks grow slowly; compare envelope and flat-bottom bags | “Folded by hand” | No | Repeating loop, then split screen |
| 5 | 0:50–1:08 | Paper and wooden experiments | Knight tests a paper model, then swaps it for a wooden prototype with visible corrections | “Paper → wood” | No | Match cut between models |
| 6 | 1:08–1:22 | A working patent model | A machinist and Knight assemble the working mechanism; Knight directs the layout | “Working model” | No | Pieces slide into place |
...
- [x] Each script beat has a clear visual purpose.
- [x] Visuals add information instead of merely repeating narration.
- [x] Text is readable on mobile.
- [x] Scene complexity fits the production schedule.
- [x] New asset proposals have been checked against `assets/`.
...
- Treat the 1871 patent diagram as evidence to simplify, not artwork to trace stylistically.
- Historical backgrounds remain muted; reserve bright gold or lime accents for cause-and-effect highlights and approved facts.
